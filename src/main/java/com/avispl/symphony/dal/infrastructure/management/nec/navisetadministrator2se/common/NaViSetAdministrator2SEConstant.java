...
/**
 * Utility class containing constant values for NaViSetAdministrator2SE API groups.
 *
 * @author Harry / Symphony Dev Team<br>
 * Created on 1/15/2024
 * @since 1.0.0
 */
public class NaViSetAdministrator2SEConstant {
	public static final String POWER_GROUP = "Power#";
