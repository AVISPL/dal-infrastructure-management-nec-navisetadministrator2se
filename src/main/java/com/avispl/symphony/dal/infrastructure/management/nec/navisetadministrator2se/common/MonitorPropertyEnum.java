 ...
 * @since 1.0.0
 */
public enum MonitorPropertyEnum {
	...
	POWER_SAVE_TIME("PowerSaveTime", NaViSetAdministrator2SEConstant.POWER_GROUP, "SaveTime(sec)"),
	POWER_OFF_TIMER("PowerOffTimer", NaViSetAdministrator2SEConstant.POWER_GROUP, "OffTimer(hrs)"),
	...
	MENU_DISPLAY_TIME("OSDMenuDisplayTime", NaViSetAdministrator2SEConstant.OSD_GROUP, "MenuDisplayTime(sec)"),
	OSD_SIZE("OSDSize", NaViSetAdministrator2SEConstant.OSD_GROUP, "Size"),
	INFORMATION_OSD("InformationOSD", NaViSetAdministrator2SEConstant.OSD_GROUP, "InformationOSD(sec)"),
	...
	ILLUMINANCE_READING("IlluminanceReading", NaViSetAdministrator2SEConstant.ECO_GROUP, "IlluminanceReading(lux)"),
	 ...
	 */
	MonitorPropertyEnum(String defaultName, String group, String propertyName) {
